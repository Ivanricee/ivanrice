...
export const CARD_INFO: CardInfo[] = [
  {
    ...
    software: ['maya', 'redshift', 'mari', 'substance 3D', 'zbrush', 'rizom uv'],
    caption: 'Totoro de Ghibli, Fan art 3D, inspirado en el otoño japonés. 🍂🎨',
    type: '3D',
    links: [
      {
        text: 'instagram',
  ...
  },
  {
    ...
    software: ['maya', 'arnold', 'nuke', 'mari', 'substance 3D', 'zbrush', 'rizom uv'],
    caption: 'steampunk spaceship. Copper material practice with arnold render.',
    type: '3D',
    links: [
      {
        text: 'instagram',
